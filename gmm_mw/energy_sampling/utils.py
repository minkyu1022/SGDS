...
def get_gfn_forward_loss(mode, init_state, rnd_model, gfn_model, log_reward, coeff_matrix, exploration_std=None, return_exp=False):
    if mode == 'tb':
        ...
        loss = fwd_gafn(init_state, rnd_model, gfn_model, log_reward, exploration_std, return_exp=return_exp)
    return loss
